...
<div class="container">
  ...
  <div class="right-side">
    ...
    <form class="registration-form" id="studentForm" enctype="multipart/form-data" novalidate>
...
function togglePassword(fieldId, button) {
  ...
  if (field.type === "password") { field.type = "text"; img.src = "./Photos/icons8-eye-24.png"; }
  else { field.type = "password"; img.src = "./Photos/icons8-closed-eye-24.png"; }
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  passwordInput.addEventListener("input", () => {
    ...
    if (passed === 4) { strengthLevel.textContent = "Strong"; strengthLevel.style.color = "green"; }
    else if (passed >= 2) { strengthLevel.textContent = "Medium"; strengthLevel.style.color = "orange"; }
    else { strengthLevel.textContent = "Weak"; strengthLevel.style.color = "red"; }
  });
    ...
    fetch("register_student.php", { method: "POST", body: formData })
      ...
      .then(result => {
        ...
        if (result.status === "success") {
          showFormError(result.message, true);
          this.reset();
